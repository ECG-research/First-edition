...
from fastai.layers import SEModule, SimpleSelfAttention
...
class XResNet1d(nn.Sequential):
    @delegates(ResBlock)
    def __init__(self, block, expansion, layers, p=0.0, input_channels=3, num_classes=5, stem_szs=(32,32,64),kernel_size=5,kernel_size_stem=5,
